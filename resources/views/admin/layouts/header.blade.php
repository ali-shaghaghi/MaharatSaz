                        ...
                        <div class="p-3">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <a href="#">
                                        <div
                                            class="pt-3 pb-3 mb-3 text-center d-flex flex-column font-size-13 bg-danger-bright bg-hover border-radius-1 text-danger">
                                            <i class="mb-2 fa fa-sitemap font-size-20"></i>
                                            دسته‌بندی ها
                                        </div>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="#">
                                        <div
                                            class="pt-3 pb-3 mb-3 text-center d-flex flex-column font-size-13 bg-info-bright bg-hover border-radius-1 text-info">
                                            <i class="mb-2 ti-game font-size-20"></i>
                                            محصولات
                                        </div>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="#">
                                        <div
                                            class="pt-3 pb-3 text-center d-flex flex-column font-size-13 bg-warning-bright bg-hover border-radius-1 text-warning">
                                            <i class="mb-2 ti-bar-chart-alt font-size-20"></i>
                                            گزارشات
                                        </div>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="#">
                                        <div
                                            class="pt-3 pb-3 text-center d-flex flex-column font-size-13 bg-secondary-bright bg-hover border-radius-1 text-secondary">
                                            <i class="mb-2 fa fa-share font-size-20"></i>
                                            سایر
                                        </div>
                                    </a>
                                </div>
