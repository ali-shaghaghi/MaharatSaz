<main>
    <!-- ======================= Main Banner START -->
    <section class="pt-5 overflow-hidden position-relative pt-lg-3">
        <!-- SVG START -->
        ...
        <!-- SVG START -->
        <span class="mt-5 position-absolute top-50 end-0 translate-middle-y me-n5 d-none d-xxl-inline-flex">
        ...
        <!-- SVG START -->
        <figure class="top-0 position-absolute start-0 ms-5">
        ...
        <div class="container">
            ...
            <div class="row align-items-center g-5">
                <!-- Left content START -->
                <div class="mb-5 text-center col-lg-5 col-xl-6 position-relative z-index-1 text-lg-start mb-sm-0">
                    <!-- SVG -->
                    <figure class="bottom-0 fill-warning position-absolute end-0 me-5 d-none d-xl-block">
                    ...
                    <!-- SVG -->
                    <figure class="top-0 fill-success position-absolute start-50 translate-middle-x mt-n5 ms-5">
                    ...
                    <!-- Info -->
                    <ul class="mb-4 list-inline position-relative justify-content-center justify-content-lg-start">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
                        <!-- Button -->
                        <a href="#" class="mb-4 btn btn-lg btn-danger-soft me-2 mb-sm-0">شروع کن</a>
                        <!-- Video button -->
                        <div class="py-2 d-flex align-items-center justify-content-center ms-0 ms-sm-4">
                            <a data-glightbox data-gallery="office-tour"
                                href="https://www.aparat.com/video/video/embed/videohash/31hor/vt/frame"
                                class="mb-0 overflow-visible btn btn-round btn-primary-shadow me-7">
                ...
                <!-- Right content START -->
                <div class="text-center col-lg-7 col-xl-6 position-relative">
                    <!-- SVG decoration -->
                    <figure class="bottom-0 mt-4 mb-0 position-absolute start-50 translate-middle-x">
                    ...
                    <!-- SVG decoration -->
                    <figure class="bottom-0 position-absolute start-50 translate-middle-x mb-n5 z-index-9">
                    ...
                    <div
                        ...
                        <img src="{{ url('front/assets/images/client/science.svg') }}" alt="Icon">
                    </div>
                    <div class="top-0 p-2 bg-white shadow rounded-3 position-absolute end-0 me-5">
                        <img src="{{ url('front/assets/images/client/angular.svg') }}" alt="Icon">
                    </div>
                    <div
                        class="p-2 mt-5 bg-white shadow rounded-3 position-absolute top-50 end-0 translate-middle-y ms-5 d-none d-lg-block z-index-9">
                        <img src="{{ url('front/assets/images/client/figma.svg') }}" alt="Icon">
                    </div>
                    <!-- Icon logos END -->

                    <!-- Congratulations message -->
                    <div
                        class="bottom-0 p-3 mb-5 border shadow bg-blur border-light rounded-4 position-absolute start-0 z-index-9 d-none d-xl-block ms-5">
                        <div class="d-flex justify-content-between align-items-center">
                            <!-- Icon -->
                            <span class="icon-lg bg-warning rounded-circle"><i
                                    class="text-white fas fa-envelope"></i></span>
                            <!-- Info -->
                            <div class="text-start ms-3">
                                <h6 class="mb-0 text-white">تبریک میگم!<span class="ms-4"><i
                                            class="fas fa-check-circle text-success"></i></span></h6>
                                <p class="mb-0 text-white small">پذیرش شما تکمیل شد</p>
                            </div>
                        </div>
                    </div>

                    <!-- Active student -->
                    <div class="p-3 shadow-lg bg-success d-inline-block rounded-4 position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block"
                        style="background:url({{ url('front/assets/images/pattern/01.png') }}) no-repeat center center; background-size:cover;">
                        <p class="text-white">دانشجویان جدید امروز ما</p>
                        <!-- Avatar group -->
                        <ul class="mb-0 avatar-group">
                            <li class="avatar avatar-sm">
                                <img class="border-white avatar-img rounded-circle" src="{{ url('front/assets/images/avatar/01.jpg') }}"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="border-white avatar-img rounded-circle" src="{{ url('front/assets/images/avatar/02.jpg') }}"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="border-white avatar-img rounded-circle" src="{{ url('front/assets/images/avatar/03.jpg') }}"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="border-white avatar-img rounded-circle" src="{{ url('front/assets/images/avatar/04.jpg') }}"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <div class="border-white avatar-img rounded-circle bg-primary">
                                    <span
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-sm-6 col-xl-3">
                    <div
                        class="p-4 d-flex justify-content-center align-items-center bg-warning bg-opacity-15 rounded-3">
                        <span class="mb-0 display-6 lh-1 text-warning"><i class="fas fa-tv"></i></span>
                        <div class="mb-0 ms-4 h6 fw-normal">
                            <div class="d-flex">
                ...
                <!-- Counter item -->
                <div class="col-sm-6 col-xl-3">
                    <div class="p-4 d-flex justify-content-center align-items-center bg-blue bg-opacity-10 rounded-3">
                        <span class="mb-0 display-6 lh-1 text-blue"><i class="fas fa-user-tie"></i></span>
                        <div class="mb-0 ms-4 h6 fw-normal">
                            <div class="d-flex">
                                <h5 class="mb-0 purecounter fw-bold" data-purecounter-start="0"
                ...
                <div class="col-sm-6 col-xl-3">
                    <div
                        class="p-4 d-flex justify-content-center align-items-center bg-purple bg-opacity-10 rounded-3">
                        <span class="mb-0 display-6 lh-1 text-purple"><i class="fas fa-user-graduate"></i></span>
                        <div class="mb-0 ms-4 h6 fw-normal">
                            <div class="d-flex">
                                <h5 class="mb-0 purecounter fw-bold" data-purecounter-start="0"
                ...
                <!-- Counter item -->
                <div class="col-sm-6 col-xl-3">
                    <div class="p-4 d-flex justify-content-center align-items-center bg-info bg-opacity-10 rounded-3">
                        <span class="mb-0 display-6 lh-1 text-info"><i class="bi bi-patch-check-fill"></i></span>
                        <div class="mb-0 ms-4 h6 fw-normal">
                            <div class="d-flex">
                                <h5 class="mb-0 purecounter fw-bold" data-purecounter-start="0"
    ...
    <section>
        <div class="container">
            ...
            <!-- Tabs START -->
            <ul class="px-3 mb-4 nav nav-pills nav-pills-bg-soft justify-content-sm-center" id="course-pills-tab"
                role="tablist">
                <!-- Tab item -->
                <li class="nav-item me-2 me-sm-5">
                    <button class="mb-2 nav-link mb-md-0 active" id="course-pills-tab-1" data-bs-toggle="pill"
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="shadow card h-100">
                                <!-- Image -->
                                <img src="{{ url('front/assets/images/courses/4by3/08.jpg') }}" class="card-img-top" alt="course image">
                                <!-- Card body -->
                                <div class="pb-0 card-body">
                                    ...
                                    <div class="mb-2 d-flex justify-content-between">
                                        <a href="#" class="badge bg-purple bg-opacity-10 text-purple">همه
                                            سطح</a>
                                        <a href="#" class="mb-0 h6"><i class="far fa-heart"></i></a>
                                    </div>
                                    <!-- Title -->
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="shadow card h-100">
                                <!-- Image -->
                                <img src="{{ url('front/assets/images/courses/4by3/02.jpg') }}" class="card-img-top" alt="course image">
                                <div class="pb-0 card-body">
                                    <!-- Badge and favorite -->
                                    <div class="mb-2 d-flex justify-content-between">
                                        <a href="#"
                                            class="badge bg-success bg-opacity-10 text-success">مقدماتی</a>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="shadow card h-100">
                                <!-- Image -->
                                <img src="{{ url('front/assets/images/courses/4by3/03.jpg') }}" class="card-img-top" alt="course image">
                                <div class="pb-0 card-body">
                                    <!-- Badge and favorite -->
                                    <div class="mb-2 d-flex justify-content-between">
                                        <a href="#"
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="shadow card h-100">
                                <!-- Image -->
                                <img src="{{ url('front/assets/images/courses/4by3/07.jpg') }}" class="card-img-top" alt="course image">
                                <div class="pb-0 card-body">
                                    <!-- Badge and favorite -->
                                    <div class="mb-2 d-flex justify-content-between">
                                        <a href="#"
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="shadow card h-100">
                                <!-- Image -->
                                <img src="{{ url('front/assets/images/courses/4by3/11.jpg') }}" class="card-img-top" alt="course image">
                                <div class="pb-0 card-body">
                                    <!-- Badge and favorite -->
                                    <div class="mb-2 d-flex justify-content-between">
                                        <a href="#" class="badge bg-purple bg-opacity-10 text-purple">همه
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="shadow card h-100">
                                <!-- Image -->
                                <img src="{{ url('front/assets/images/courses/4by3/12.jpg') }}" class="card-img-top" alt="course image">
                                <div class="pb-0 card-body">
                                    <!-- Badge and favorite -->
                                    <div class="mb-2 d-flex justify-content-between">
                                        <a href="#"
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="shadow card h-100">
                                <!-- Image -->
                                <img src="{{ url('front/assets/images/courses/4by3/04.jpg') }}" class="card-img-top" alt="course image">
                                <div class="pb-0 card-body">
                                    <!-- Badge and favorite -->
                                    <div class="mb-2 d-flex justify-content-between">
                                        <a href="#" class="badge bg-purple bg-opacity-10 text-purple">همه
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="shadow card h-100">
                                <!-- Image -->
                                <img src="{{ url('front/assets/images/courses/4by3/09.jpg') }}" class="card-img-top" alt="course image">
                                <div class="pb-0 card-body">
                                    <!-- Badge and favorite -->
                                    <div class="mb-2 d-flex justify-content-between">
                                        <a href="#" class="badge bg-purple bg-opacity-10 text-purple">همه
                                    ...
                                    <ul class="mb-0 list-inline">
                                        ...
                                        <li class="list-inline-item me-0 small"><i
                                                class="fas fa-star text-warning"></i></li>
                                        <li class="mb-0 list-inline-item ms-2 h6 fw-light">5.0/5.0</li>
                                    </ul>
                                </div>
                                <!-- Card footer -->
                                <div class="pt-0 pb-3 card-footer">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span class="mb-0 h6 fw-light"><i class="fas fa-table text-orange me-2"></i>89
                                            دوره</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="tab-pane fade" id="course-pills-tabs-2" role="tabpanel"
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="shadow card h-100">
                                <!-- Image -->
                                <img src="{{ url('front/assets/images/courses/4by3/05.jpg') }}" class="card-img-top" alt="course image">
                                <div class="pb-0 card-body">
                                    <!-- Badge and favorite -->
                                    <div class="mb-2 d-flex justify-content-between">
                                        <a href="#"
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="shadow card h-100">
                                <!-- Image -->
                                <img src="{{ url('front/assets/images/courses/4by3/06.jpg') }}" class="card-img-top" alt="course image">
                                <div class="pb-0 card-body">
                                    <!-- Badge and favorite -->
                                    <div class="mb-2 d-flex justify-content-between">
                            ...
                            <div class="shadow card h-100">
                                ...
                                <div class="pb-0 card-body">
                                    ...
                                    <div class="mb-2 d-flex justify-content-between">
                                        <a href="#" class="badge bg-purple bg-opacity-10 text-purple">همه
                                            سطح</a>
                                        <a href="#" class="mb-0 h6 fw-light"><i
    ...
    <section class="pt-0 pt-lg-5">
        <div class="container position-relative">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="p-4 bg-info p-sm-5 rounded-3">
                        <div class="row position-relative">
                            ...
                            <!-- Action box -->
                            <div class="mx-auto col-11 position-relative">
                                <div class="row align-items-center">
                                    <!-- Title -->
                                    <div class="col-lg-7">
                                        <h3 class="text-white">مدرس شویـد!</h3>
                                        <p class="mb-3 text-white mb-lg-0">ارائه راهکارها و شرایط سخت تایپ به
                                    ...
                                    <div class="col-lg-5 text-lg-end">
                                        <a href="#" class="mb-0 btn btn-outline-warning">ثبت نام</a>
                                    </div>
                                </div>
                            </div>
                        </div> <!-- Row END -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="tiny-slider arrow-round arrow-blur arrow-hover">
                    <div class="pb-1 tiny-slider-inner" data-autoplay="true" data-arrow="true" data-edge="2"
                        ...
                        <div>
                            <div class="bg-transparent border card action-trigger-hover">
                                ...
                                <img src="assets/images/courses/4by3/14.jpg" class="card-img-top"
                                    alt="course image">
                                <!-- Ribbon -->
                                <div class="mt-3 ribbon"><span>رایگان</span></div>
                                <!-- Card body -->
                                <div class="pb-0 card-body">
                                    <!-- Badge and favorite -->
                                    <div class="mb-3 d-flex justify-content-between">
                                        <span class="gap-2 hstack">
                                            <a href="#"
                                                class="badge bg-primary bg-opacity-10 text-primary">طراحی وب</a>
                                    ...
                                    <div class="mb-2 d-flex justify-content-between">
                                        <div class="gap-2 hstack">
                                            <p class="m-0 text-warning">4.5<i
                                                    class="fas fa-star text-warning ms-1"></i></p>
                                            <span class="small">(6500)</span>
                                        </div>
                                        <div class="gap-2 hstack">
                                            <p class="m-0 mb-0 h6 fw-light">6500</p>
                                ...
                                <div class="pt-0 bg-transparent card-footer">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <p class="mb-0 ms-2"><a href="#" class="mb-0 h6 fw-light">مهرداد
                                                    نوروزی</a></p>
                                        </div>
                                        <!-- Price -->
                                        <div>
                                            <h5 class="mb-0 text-success item-show">رایگـان</h5>
                        ...
                        <div>
                            <div class="bg-transparent border card action-trigger-hover">
                                ...
                                <div class="pb-0 card-body">
                                    ...
                                    <div class="mb-2 d-flex justify-content-between">
                                        <div class="gap-2 hstack">
                                            <p class="m-0 text-warning">4.0<i
                                                    class="fas fa-star text-warning ms-1"></i></p>
                                            <span class="small">(3500)</span>
                                        </div>
                                        <div class="gap-2 hstack">
                                            <p class="m-0 mb-0 h6 fw-light">4500</p>
                                            <span class="small">(دانشجو)</span>
                                        </div>
                                    </div>
                                    <!-- Time -->
                                ...
                                <div class="pt-0 bg-transparent card-footer">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <p class="mb-0 ms-2"><a href="#" class="mb-0 h6 fw-light">علی
                                                    صالحی</a></p>
                                        </div>
                                        <!-- Price -->
                                        <div>
                                            <h5 class="mb-0 text-success item-show">30,000 تومان</h5>
                                            <a href="#" class="btn btn-sm btn-success-soft item-show-hover"><i
                                                    class="fas fa-shopping-cart me-2"></i>افزودن به سبد</a>
                                        </div>
                                    </div>
                            ...
                            <div class="bg-transparent border card action-trigger-hover">
                                ...
                                <div class="pb-0 card-body">
                                    ...
                                    <div class="mb-3 d-flex justify-content-between">
                                        <span class="gap-2 hstack">
                                            <a href="#"
                                                class="badge bg-primary bg-opacity-10 text-primary">برنامه
                                                نویسی</a>
                                            <a href="#" class="badge text-bg-dark">مقدماتی</a>
                                        </span>
                                        <a href="#" class="mb-0 h6 fw-light"><i
                                    ...
                                    <div class="mb-2 d-flex justify-content-between">
                                        ...
                                        <div class="gap-2 hstack">
                                            <p class="m-0 mb-0 h6 fw-light">8000</p>
                                            <span class="small">(دانشجو)</span>
                                        </div>
                                    </div>
                                    <!-- Time -->
                                ...
                                <div class="pt-0 bg-transparent card-footer">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <p class="mb-0 ms-2"><a href="#" class="mb-0 h6 fw-light">الهام
                                                    نصرتی</a></p>
                                        </div>
                                        <!-- Price -->
                                        <div>
                                            <h5 class="mb-0 text-success item-show">135,000 تومان</h5>
                                            <a href="#" class="btn btn-sm btn-success-soft item-show-hover"><i
                                                    class="fas fa-shopping-cart me-2"></i>افزودن به سبد</a>
                                        </div>
                                    </div>
                        ...
                        <div>
                            <div class="bg-transparent border card action-trigger-hover">
                                <!-- Image -->
                                <img src="{{ url('front/assets/images/courses/4by3/16.jpg') }}" class="card-img-top"
                                    alt="course image">
                                <!-- Card body -->
                                <div class="pb-0 card-body">
                                    <!-- Badge and favorite -->
                                    ...
                                    <div class="mb-2 d-flex justify-content-between">
                                        ...
                                        <div class="gap-2 hstack">
                                            <p class="m-0 mb-0 h6 fw-light">1200</p>
                                            <span class="small">(دانشجو)</span>
                                        </div>
                                    </div>
                                    <!-- Time -->
                                ...
                                <div class="pt-0 bg-transparent card-footer">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <p class="mb-0 ms-2"><a href="#" class="mb-0 h6 fw-light">زهرا
                                                    حیدری</a></p>
                                        </div>
                                        <!-- Price -->
                                        <div>
                                            <h5 class="mb-0 text-success item-show">69,000 تومان</h5>
                                            <a href="#" class="btn btn-sm btn-success-soft item-show-hover"><i
                                                    class="fas fa-shopping-cart me-2"></i>افزودن به سبد</a>
                                        </div>
                                    </div>
        ...
        <div class="container">
            <div class="row g-4 g-lg-5 align-items-center">
                <div class="order-2 col-xl-7 order-xl-1">
                    <div class="mt-0 row mt-xl-5">
                        <!-- Review -->
                        <div class="mt-0 mb-0 col-md-7 position-relative mt-md-5">
                            <!-- SVG -->
                            <figure
                                class="top-0 mb-3 fill-danger opacity-2 position-absolute start-0 translate-middle">
                            ...
                            <div class="p-4 mb-5 text-center shadow bg-body rounded-3 position-relative mb-md-0">
                                <!-- Avatar -->
                        ...
                        <!-- Mentor list -->
                        <div class="mt-5 col-md-5 mt-md-0 d-none d-md-block">
                            <div class="p-4 shadow bg-body rounded-3 d-inline-block position-relative">
                                <!-- Icon -->
                                <div
                                    class="top-0 icon-lg bg-warning rounded-circle position-absolute start-100 translate-middle">
                    ...
                    <div class="mt-5 row mt-xl-0">
                        <!-- Rating -->
                        <div class="mt-0 col-7 mt-xl-5 text-end position-relative z-index-1 d-none d-md-block">
                            <!-- SVG -->
                            <figure
                                class="top-0 pt-2 fill-danger position-absolute start-50 mt-n7 ms-6 ps-3 z-index-n1 d-none d-lg-block">
                            ...
                            <div class="p-3 text-center shadow-lg bg-primary d-inline-block rounded-4"
                                style="background:url(assets/images/pattern/02.png) no-repeat center center; background-size:cover;">
                                <!-- Info -->
                                <h5 class="mb-0 text-white">4.5/5.0</h5>
                                <!-- Rating -->
                                <ul class="mb-2 list-inline">
                                    <li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i>
                                    </li>
                                ...
                                <p class="mb-0 text-white">بر اساس 3265 رتبه بندی</p>
                            </div>
                        </div>

                        <!-- Review -->
                        <div class="mb-0 col-md-5 mt-n6 mb-md-5">
                            <div class="p-4 text-center shadow bg-body rounded-3">
                                <!-- Avatar -->
                                <div class="mb-3 avatar avatar-xl">
                ...
                <div class="order-1 text-center col-xl-5 text-xl-start">
                    <!-- Title -->
                    ...
                    <a href="#" class="mb-0 btn btn-primary">سایر دیدگاه</a>
                </div>
            </div> <!-- Row END -->
        </div>
    </section>
