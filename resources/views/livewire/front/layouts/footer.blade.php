        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3">
                ...
                <ul class="mt-3 mb-0 list-inline">
                    <li class="list-inline-item"> <a class="px-2 shadow btn btn-white btn-sm text-facebook"
                            href="#"><i class="fab fa-fw fa-facebook-f"></i></a> </li>
                    <li class="list-inline-item"> <a class="px-2 shadow btn btn-white btn-sm text-instagram"
                            href="#"><i class="fab fa-fw fa-instagram"></i></a> </li>
                    <li class="list-inline-item"> <a class="px-2 shadow btn btn-white btn-sm text-twitter"
                            href="#"><i class="fab fa-fw fa-twitter"></i></a> </li>
                    <li class="list-inline-item"> <a class="px-2 shadow btn btn-white btn-sm text-linkedin"
        ...
        <div class="py-3">
            <div class="container px-0">
                <div class="py-3 text-center d-lg-flex justify-content-between align-items-center text-md-left">
                    <!-- copyright text -->
                    <div class="text-primary-hover"> ارائه شده در سایت <a href="#" target="_blank"
                            class="text-body">کدیاد</a></div>
                    <!-- copyright links-->
                    <div class="mt-3 justify-content-center mt-lg-0">
                        <ul class="mb-0 nav list-inline justify-content-center">
                            <li class="list-inline-item">
                                <!-- Language selector -->
                                <div class="mt-0 text-center dropup text-sm-end">
